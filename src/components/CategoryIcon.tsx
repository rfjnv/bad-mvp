...
const ICONS: Record<string, React.ReactNode> = {
  ...
  // Йод — капля над волной
  iodine: (
    <Svg>
      <path d="M12 2.6s4.2 4.7 4.2 7.5a4.2 4.2 0 0 1-8.4 0c0-2.8 4.2-7.5 4.2-7.5Z" />
      <path d="M2.5 16.5c1.6-1.4 3.2-1.4 4.8 0s3.2 1.4 4.8 0 3.2-1.4 4.8 0 3.2 1.4 4.6 0" />
      <path d="M2.5 20.4c1.6-1.4 3.2-1.4 4.8 0s3.2 1.4 4.8 0 3.2-1.4 4.8 0 3.2 1.4 4.6 0" />
    </Svg>
  ),
  // Иммунитет — щит
  immunity: (
